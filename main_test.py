...
ET.SubElement(Items, "Item", attrib={"GUIDString":'{' + str(uuid.uuid4()) + '}',
                                     "MainParentIdent":"{B5E17EDB-D3F5-49B2-AEEB-9A0AA5A23838}", "Code":"5",
                                     "Name":"SORBETTO", "AltName":"SORBETTO", "Status":"rsActive", "TaxDishType":"1",
                                     "ExtCode":"5", "PRICETYPES-3":"100000", "CLASSIFICATORGROUPS-512":"513",
