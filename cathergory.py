...
for i in l_ist:
    for b in i:
        if i[17] not in l_ist_libellé_famille and i[17] is not None and i[17] != " " and i[17] != "":
            ...
            ET.SubElement(Items, "Item", attrib={"GUIDString":'{' + str(uuid.uuid4()) + '}',
                                         "Code":i[16], "Name":i[17], "AltName":i[17], "Status":"rsActive", "ExtCode":i[16]}).text
            ...
            for item in parsed_response.findall("."):
                ...
                if attr_of_item_node.get("Status") == "Ok":
                    ...
                    error_count += 1
            l_ist_libellé_famille.append(i[17])
